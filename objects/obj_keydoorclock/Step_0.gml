...
with (obj_player)
{
	if (place_meeting(x, y, obj_keydoorclock) && state = 0 && other.sprite_index == spr_clockdoor && obj_player.grounded && key_up && (state = 0 || state = 62 || state = 63 || state = 83) && y == (other.y + 50) && !instance_exists(obj_noisesatellite) && !instance_exists(obj_fadeout) && state != 71 && state != 57 && state != 54)
	{
