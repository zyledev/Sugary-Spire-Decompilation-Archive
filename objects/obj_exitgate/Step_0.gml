...
if (place_meeting(x, y, obj_player) && obj_player.state != 54 && sprite_index == spr_enterexitgate && !global.panic && obj_player.sprite_index != obj_player.spr_lookdoor && sprite_index != spr_exitgateclosed)
{
